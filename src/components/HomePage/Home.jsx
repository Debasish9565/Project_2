  ...
  return (
    <div className={styles.container}>
      <div className={styles.forms}>
        <div style={{ marginRight: "10px" }}>
          ...
          <div className={styles.offerTop}>
            ...
            <p>
              To celebrate 25 years of finding the right trip for the entire
              family, save 25% or more on select hotels!
            </p>
        ...
        <div className={styles.info1InnerDiv}>
          <div style={{ width: "50%" }}>
            ...
            <p className={styles.info1Para}>
              Book on the Travelocity app and we’ll help get a Covid vaccine to
              someone, somewhere who needs it. Let's reopen the world, one trip,
              one shot at a time.
            </p>
      ...
      <div className={styles.info1BottomPara}>
        <p>
          For every eligible Travelocity booking, Expedia, Inc. will donate $2
          USD, up to $12 million USD, in support of UNICEF’s global COVID-19
          response. Expedia, Inc. pledges a minimum donation of $10 million USD.
          Certain eligibility criteria apply. Click Learn more above for
          complete program terms. Learn more about UNICEF's work at{" "}
          <a href="http://www.unicef.org" target="_blank" rel="noreferrer">
            www.unicef.org
          </a>{" "}
        </p>
      </div>
      <div className={styles.info2}>
        <Grid container>
          <Grid item xs={12} sm={8}>
            ...
            >
              <div className={styles.info2Img}></div>
              <div className={styles.info2ImgDescription}>
                <img
                  src="	https://tpc.googlesyndication.com/simgad/11901415560359135758?"
                  alt=""
                />
          ...
          <Grid xs={12} sm={4}>
            <div>
              ...
              <div className={styles.info2Right}>
                <div
                  className={`${styles.info2RightImg1} ${styles.info2RightImg2}`}
                ></div>
                <div style={{ width: "70%" }}>
                  <h2>Vacation Packages Under $400</h2>
                  <p>
                    Book your flight and hotel together, and together, we can
                    make it happen.
                  </p>
                </div>
              </div>
