...
export default function ScrollableTabsButtonForce() {
  ...
  const [flightLeavingSearchPopup, setFlightLeavingSearchPopup] =
    useState("none");
  ...
  const handleSearchByQuery = () => {
    ...
    axios
      .get(`https://my-api-data.herokuapp.com/places?q=${query}&_limit=50`)
      .then((res) => {
  ...
  const handleAdulTrevelersCnt = (e, val) => {
    e.stopPropagation();
    if (
      (val === -1 && AdultsTrevelers === 1) ||
      (val === 1 && AdultsTrevelers === 20)
    ) {
      return;
    }
  ...
  const handleAdulTrevelersRoomCnt = (e, val) => {
    e.stopPropagation();
    if (
      (val === -1 && trevelersRoomCnt === 1) ||
      (val === 1 && trevelersRoomCnt === 5)
    ) {
      return;
    }
        ...
        <div className={styles.hotelContainer}>
          ...
          >
            ...
            <div
              ...
              style={{ display: `${openLocationSearch}` }}
            >
              <input
                ref={searchRef}
                value={query}
          ...
          <div className={`${styles.hotelBtns} ${styles.hoteldateBtn}`}>
            ...
            <div className={styles.HeadingGoingto}>
              ...
              <div className={styles.checkinDate}>{`${startDate.getDate()} ${
                monthNames[startDate.getMonth()]
              } ${sort_year(startDate)}`}</div>
          ...
          <div className={`${styles.hotelBtns} ${styles.hoteldateBtn}`}>
            ...
            <div className={styles.HeadingGoingto}>
              ...
              <div className={styles.checkinDate}>{`${endDate.getDate()} ${
                monthNames[endDate.getMonth()]
              } ${sort_year(endDate)}`}</div>
            </div>
            <MuiPickersUtilsProvider utils={DateFnsUtils}>
              <MaterialUIPickers
                props={{ handleEndDate }}
          ...
          >
            ...
            <div
              className={styles.traverlersPopup}
              style={{ display: `${trevelersPopupOpen}` }}
            >
              <div>
                <h3 className={styles.travelersPopupHeading}>Travelers</h3>
              </div>
              <div className={styles.trevelersFlexContainer}>
                <h3 className={styles.treveleresAdultSelector}>
                  Room (Max 4 Adults/per room)
                </h3>
      ...
      <TabPanel value={value} index={1}>
        <div className={styles.hotelContainer}>
          ...
          >
            ...
            <div
              className={styles.searchBox}
              style={{ display: `${flightLeavingSearchPopup}` }}
            >
              <input
                ref={searchRef}
                value={query}
                  ...
                  return (
                    <div key={uuid()} className={styles.SearchResult}>
                      <div
                        className={styles.SearchResultIndividual}
                        onClick={(e) => {
                          handleFlightLeavingCloseSearchPopup(
                            `${data.name}`,
                            e
                          );
                        }}
          ...
          <div
            style={{ width: "28%" }}
            className={`${styles.hotelBtns} ${styles.hoteldateBtn}`}
          >
            <EventIcon className={styles.Icon} />
            <div className={styles.HeadingGoingto}>
