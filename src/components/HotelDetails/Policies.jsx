      ...
      <div className={styles.policies}>
        ...
        <div className={styles.right_2}>
          <div className={styles.margin}>
            ...
            <p>
              The check-in location differs from the property location; to check
              in, go to Taj Club Reception for Taj Club Rooms and Suites
            </p>
            <p>This property doesn't offer after-hours check-in</p>
            <p>
              To make arrangements for check-in please contact the property
              ahead of time using the information on the booking confirmation
            </p>
            <p>
            ...
            <p>
              ...
              India; Permanent Account Number (PAN) cards will not be accepted
              due to national regulations. Travelers who are not citizens of
              India must present a valid passport and visa. Indian citizens must
              show a PAN card at check-out for cash transactions exceeding INR
              25,000.
            </p>
          </div>
          <div className={styles.margin}>
          ...
          <div className={styles.margin}>
            ...
            <p>
              Kids stay free! Up to 2 children 8 years old and younger stay free
